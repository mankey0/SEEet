...
import hantavirus_img from '../assets/Pest and Rodent Control/hantavirus control.jpg'
import hantavirus1 from '../assets/Pest and Rodent Control/hantavirus1.jpg'
import hantavirus2 from '../assets/Pest and Rodent Control/hantavirus2.jpg'
...
const Hantavirus = ({ language }) => {
  ...
  const text = {
    en: {
      banner: {
        title: 'Hantavirus Control',
        home: 'Home',
        services: 'Services',
      },
      caption_services: {
        title: "Hantavirus Control Services",
        caption: "Hantavirus is a type of virus that is transmitted to humans through direct or indirect contact with infected rodents, such as mice and rats. This virus is considered to cause serious diseases, such as Hantavirus Pulmonary Syndrome (HPS) and Hemorrhagic Fever with Renal Syndrome (HFRS).",
        subheading_1: "Dangers of Hantavirus:",
        subheading_2: "The Correct Way to Get Rid of Hantavirus:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Hantavirus is a rare but serious disease transmitted to humans through contact with the feces, urine, or saliva of infected rodents or by inhaling airborne particles from these excretions. The risks include:",
        content: [
          "Hantavirus Pulmonary Syndrome (HPS): A disease causing severe respiratory issues and can be fatal if not treated promptly.",
          "Hemorrhagic Fever with Renal Syndrome (HFRS): Causes kidney damage, bleeding, and low blood pressure. Avoid rodent-infested areas and follow preventive measures to stay safe.",
      ...
      accordion2: {
        title: "The Correct Way to Get Rid of Hantavirus:",
        content: [
          "Hantavirus is a respiratory virus transmitted through rodents, posing a health risk that can lead to severe respiratory diseases.",
          "Thorough Cleaning: Clean surfaces using effective disinfectants that contain ingredients capable of killing viruses. Avoid sweeping or cleaning contaminated areas with dry dust to reduce the spread of the virus in the air.",
          "Handling Rodents with Care: Wear protective gloves when disposing of rodents or their droppings. Place dead rodents or their droppings in tightly sealed plastic bags and dispose of them safely.",
          
        ]
      },
      accordion3: {
        title: "Features of Sert Hantavirus Control Company:",
        content: [
          "Advanced Technologies: Utilizing the latest technologies and equipment for disinfecting and sanitizing spaces.",
          "Safe and Effective Products: Relying on certified disinfectants that eliminate viruses, including Hantavirus, without causing harm to the environment or individuals.",
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "Sert Hantavirus Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
      Advantages: {
    ...
    ar: {
      banner: {
        title: 'مكافحة فيروس هانتا',
        home: 'الرئيسية',
        services: 'الخدمات',
      },
      caption_services: {
        title: "خدمات مكافحة فيروس هانتا ",
        caption: "فيروس هانتا هو نوع من الفيروسات الذي ينتقل إلى البشر عبر الاتصال المباشر أو غير المباشر مع القوارض المصابة، مثل الفئران والجرذان. يُعتبر هذا الفيروس مسببًا لأمراض خطيرة، مثل متلازمة فيروس هانتا الرئوية (HPS) والحمى النزفية المصاحبة لمتلازمة الكلى (HFRS).",
        subheading_1: "فيروس هانتا مخاطر :",
        subheading_2: "الطريقة الصحيحة للتخلص من فيروس هانتا:",
        subheading_3: " مميزات شركة صيت:",
      },


      accordion1: {
        title: "فيروس هانتا هو مرض نادر ولكنه خطير ينتقل إلى الإنسان عبر ملامسة الفضلات أو البول أو اللعاب الخاص بالقوارض المصابة، أو من خلال استنشاق الجزيئات المحمولة بالهواء من هذه الفضلات. تشمل المخاطر:",
        content: [
          "متلازمة فيروس هانتا الرئوية (HPS): مرض يسبب مشاكل تنفسية حادة وقد يؤدي إلى الوفاة إذا لم يتم علاجه بسرعة.",
          "الحمى النزفية مع المتلازمة الكلوية (HFRS): تسبب آلامًا في الكلى، نزيفًا، وهبوطًا في ضغط الدم. ينصح بتجنب الأماكن التي تعيش فيها القوارض واتخاذ تدابير الوقاية المناسبة.",
        ]
      },
      accordion2: {
        title: "هو فيروس تنفسي ينتقل عبر القوارض، ويشكل خطرًا على الصحة يمكن أن يؤدي إلى أمراض تنفسية حادة. ",
        content: [
          
          "التنظيف الشامل: قم بتنظيف الأسطح باستخدام مطهرات فعّالة تحتوي على مواد تقضي على الفيروسات. تجنب كنس أو تنظيف المناطق الملوثة بالغبار الجاف لتقليل انتشار الفيروس في الهواء.",
          "التعامل مع القوارض بحذر: ارتدِ قفازات واقية أثناء التخلص من القوارض أو فضلاتها. ضع الفئران أو القوارض الميتة وفضلاتها في أكياس بلاستيكية محكمة الإغلاق، وتخلص منها بطريقة آمنة.",
          
        ]
      },
      accordion3: {
        title: "مميزات شركة صيت لمكافحة فيروس هانتا:",
        content: [
          "تقنيات حديثة: استخدام أحدث التقنيات والمعدات لتعقيم وتطهير الأماكن.",
          "منتجات آمنة وفعالة: الاعتماد على مطهرات معتمدة تقضي على الفيروسات، بما فيها فيروس هانتا دون التسبب بأي ضرر للبيئة أو الأفراد.",
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صست لمكافحة فيروس هانتا حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={hantavirus_img} className="d-block img-fluid w-100" style={{ objectPosition: "center" }} alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
              ...
              <div className="carousel-item ">
                <div className="img-services">
                  <img src={hantavirus1} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
              ...
              <div className="carousel-item">
                <div className="img-services">
                  <img src={hantavirus2} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
                      ...
                      <div className="card-wraper">
                        ...
                        <div className="card col-md-5">
                          <div className="card-body">
                            ...
                            <Link to="../Home/services/bed-bugs" className="card-link">

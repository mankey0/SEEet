...
import hepatitisB_Disinfection from '../assets/Pest and Rodent Control/HepatitisB control.jpg'
import hepatitisB_1 from '../assets/Pest and Rodent Control/hepatitisB-1.jpg'
import HepatitisB_2 from '../assets/Pest and Rodent Control/HepatitisB-2.jpg'
...
const HepatitisB = ({ language }) => {
  ...
  const text = {
    en: {
      banner: {
        title: 'Hepatitis B Control',
        home: 'Home',
        services: 'Services',
      },
      caption_services: {
        title: "Hepatitis B Control Services",
        caption: "Hepatitis B is a viral infection that affects the liver, caused by the Hepatitis B Virus (HBV). It is one of the most common liver diseases worldwide. The virus spreads through blood or body fluids, such as during unprotected sexual contact, from mother to child during childbirth, or through contaminated tools like needles or razors.",
        subheading_1: "Dangers of Hepatitis B:",
        subheading_2: "The Correct Way to Get Rid of Hepatitis B:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Hepatitis B is a viral infection that affects the liver and can cause a range of serious health risks, including:",
        content: [
          "Cirrhosis: Chronic inflammation can lead to liver tissue damage, causing scarring (cirrhosis) that may impair liver function.",
          "Liver failure: In advanced cases, Hepatitis B can lead to liver failure, which may require a liver transplant.",
          "Liver cancer: Chronic Hepatitis B infection can cause liver cancer (hepatocellular carcinoma)."
      ...
      accordion2: {
        title: "The Correct Way to Get Rid of Hepatitis B:",
        content: [
          "Vaccination: The most effective way to prevent Hepatitis B is through vaccination. The vaccine is safe and highly effective in protecting against the virus.",
          "Antiviral Medication: For chronic Hepatitis B, antiviral medications may be prescribed to control the virus and prevent liver damage.",
          "Regular Monitoring: Individuals with chronic Hepatitis B should undergo regular check-ups and liver function tests to monitor for complications such as cirrhosis or liver cancer.",
          "Healthy Lifestyle: Maintaining a healthy lifestyle by avoiding alcohol, eating a balanced diet, and exercising can help support liver health."
      ...
      accordion3: {
        title: "Features of Sert Hepatitis B Control Company:",
        content: [
          "Advanced Technologies: Utilizing the latest technologies and equipment for disinfecting and sanitizing spaces.",
          "Safe and Effective Products: Relying on certified disinfectants that eliminate viruses, including Hepatitis B, without causing harm to the environment or individuals.",
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "Sert Hepatitis B Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
    ...
    ar: {
      banner: {
        title: 'مكافحة التهاب الكبد B',
        home: 'الرئيسية',
        services: 'الخدمات',
      },
      caption_services: {
        title: " خدمات مكافحة التهاب الكبد B ",
        caption: "التهاب الكبد B هو عدوى فيروسية تصيب الكبد، يسببها فيروس التهاب الكبد B (HBV). يُعتبر من أكثر أمراض الكبد انتشارًا حول العالم. ينتقل الفيروس عن طريق الدم أو سوائل الجسم، مثل خلال العلاقات الجنسية غير المحمية، أو من الأم إلى الطفل أثناء الولادة، أو استخدام أدوات ملوثة مثل الإبر أو شفرات الحلاقة.",
        subheading_1: " التهاب الكبد B مخاطر :",
        subheading_2: "الطريقة الصحيحة للتخلص من التهاب الكبد B:",
        subheading_3: " مميزات شركة صيت:",
      },


      accordion1: {
        title: "التهاب الكبد B هو عدوى فيروسية تؤثر على الكبد ويمكن أن تسبب مجموعة من المخاطر الصحية الخطيرة،",
        content: [
          "التليف الكبدي: يمكن أن يؤدي الالتهاب المزمن إلى تلف الأنسجة في الكبد، مما يسبب تندبًا (تليفًا) قد يضر بوظائف الكبد.",
          "فشل الكبد: في حالات متقدمة، يمكن أن يتسبب التهاب الكبد B في فشل الكبد، مما قد يتطلب زرع كبد.",
          "سرطان الكبد: يمكن أن يسبب التهاب الكبد B المزمن الإصابة بسرطان الكبد (سرطان الخلايا الكبدية).",
        ]
      },
      accordion2: {
      ...
      accordion3: {
        title: "مميزات شركة صيت لمكافحة التهاب الكبد B:",
        content: [
          "تقنيات حديثة: استخدام أحدث التقنيات والمعدات لتعقيم وتطهير الأماكن.",
          "منتجات آمنة وفعالة: الاعتماد على مطهرات معتمدة تقضي على الفيروسات، بما فيها التهاب الكبد B دون التسبب بأي ضرر للبيئة أو الأفراد.",
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صست لمكافحة التهاب الكبد B حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={hepatitisB_Disinfection} className="d-block img-fluid w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
              ...
              <div className="carousel-item ">
                <div className="img-services">
                  <img src={hepatitisB_1} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
              ...
              <div className="carousel-item">
                <div className="img-services">
                  <img src={HepatitisB_2} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">

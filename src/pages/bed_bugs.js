...
import bed_bug_control from '../assets/Pest and Rodent Control/bed-bug control.jpg'
import bed_bugs1 from '../assets/Pest and Rodent Control/bed-bugs1.jpg'
import bed_bugs2 from '../assets/Pest and Rodent Control/bed-bugs2.jpg'
...
const BedBugs = ({ language }) => {
  ...
  const text = {
    en: {
      ...
      caption_services: {
        title: "Bed Bugs Control Services",
        caption: "Residential buildings and hotels are particularly vulnerable to bed bug problems because of the high-density human populations. Each person is a potential source of bed bugs hitchhiking on personal belongings. Bed bugs pose high risk to hotels through causing and damaging business's reputation.",
        subheading_1: "Dangers of Bed Bugs:",
        subheading_2: "The Correct Way to Get Rid of Bed Bugs:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Bed Bugs are pests that can cause a variety of health and environmental issues in homes and offices:",
        content: [
          "Bacterial Contamination: Bed Bugs carry many types of bacteria and germs, which can spread to furniture, leading to contamination. These germs can cause diseases such as food poisoning, gastritis, and diarrhea.",
          "Furniture Damage: Bed Bugs can damage upholstered furniture or wooden furniture. Some types of Bed Bugs feed on organic materials like paper and wood, gradually causing furniture damage over time.",
          "Unpleasant Odor: Bed Bugs secrete chemicals from their bodies, leaving a foul odor on furniture, especially if they gather in specific areas and breed.",
          "Allergies: Bed Bugs can trigger allergic reactions in people who are sensitive to insects or pests. Some individuals may experience respiratory problems or skin rashes due to the presence of cockroach droppings or discarded exoskeletons.",
        ]
      },
      ...
      accordion2: {
        title: "The Correct Way to Get Rid of Bed Bugs:",
        content: [
          "Early Diagnosis: Bed Bugs presence should be detected early to control them before they cause significant damage. A pest control expert can be called to assess the situation and diagnose the infestation.",
          "Chemical Control: The most common method for getting rid of Bed Bugs involves using appropriate pesticides. A pest control expert should apply the pesticides correctly according to recommended doses and safety guidelines.",
          "Sealing and Insulation: Sealing and insulation processes should be carried out to prevent the spread of Bed Bugs. This includes replacing infested wood and sealing gaps and cavities to prevent cockroaches from reaching other areas."
        ]
      },


      accordion3: {
        title: "Features of Sert Bed Bugs Control Company:",
        content: [
          "Experience and Professionalism: The company has extensive experience in Bed Bugs control and works professionally to provide high-quality services.",
          "Use of Advanced Technologies: Sert uses advanced technologies and modern tools to detect and effectively control Bed Bugs. It relies on modern techniques to ensure comprehensive elimination of cockroaches.",
          "Customized Solutions: The company offers customized and innovative solutions for Bed Bugs control, based on studying each case and providing individualized strategies for each client according to their specific needs.",
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "Sert Bed Bugs Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
    ...
    ar: {
      ...
      caption_services: {
        title: "خدمات مكافحة بق الفراش",
        caption: "تعتبر المباني السكنية والفنادق معرضة بشكل خاص لمشاكل بق الفراش بسبب الكثافة العالية للسكان. كل شخص يمكن أن يكون مصدرًا لنقل بق الفراش من خلال التعلق بالأمتعة الشخصية. يشكل بق الفراش خطراً كبيراً على الفنادق من خلال التأثير على سمعة الأعمال التجارية.",
        subheading_1: " مخاطر بق الفراش :",
        subheading_2: " الطريقة الصحيحة للتخلص من بق الفراش:",
        subheading_3: " مميزات شركة صيت:",
      },
      accordion1: {
        title: "مخاطر بق الفراش على الأثاث:",
        content: [
          "تلف الأثاث: يعتبر بق الفراش من الحشرات التي تضر بالأثاث بشكل كبير. قد يسبب تآكل الأقمشة وتلف المفروشات بسبب عضاته التي تؤدي إلى تمزيق الأقمشة أو خدشها.",
          "التسبب في تلف الأثاث: بق الفراش يمكن أن تضر بالأثاث المنجّد أو المصنوع من الخشب. فبعض أنواع بق الفراش تتغذى على المواد العضوية مثل الورق والخشب، مما يؤدي إلى تلف الأثاث بمرور الوقت.",
          "انتقال العدوى: يمكن لبق الفراش أن يحمل أمراضًا ويعرض الأثاث للتلوث بالجراثيم والفيروسات. يتم انتقال العدوى عبر الحشرات التي تلامس الأسطح، مما يزيد من المخاطر الصحية.",
          "صعوبة العلاج: التخلص من بق الفراش قد يكون صعبًا، وقد يستدعي استخدام مواد كيميائية قوية تضر بالأثاث إذا لم يتم استخدامها بحذر.",
        ]
      },
      accordion2: {
        title: "للتخلص الفعال من بق الفراش يجب اتباع الخطوات التالية:",
        content: [
          "تحديد مكان الإصابة: أول خطوة هي التأكد من مكان وجود بق الفراش. ابحث عن علامات مثل البقع الداكنة (براز بق الفراش) أو القشور أو الحشرات نفسها في الشقوق والفواصل في الأثاث والسرير.",
          " غسل الأغطية والملابس: قم بغسل الأغطية والملابس والمفروشات في ماء ساخن (أكثر من 60 درجة مئوية) للتخلص من بق الفراش وبيضه.",
          "استخدام المبيدات الحشرية: استخدم مبيد حشري مخصص لبق الفراش يتميز بفعاليته وسلامته على الأثاث. يمكن العثور على هذه المبيدات في محلات بيع مواد التنظيف أو عبر الإنترنت. تأكد من اتباع التعليمات الخاصة بالمبيد للحفاظ على سلامة الأثاث والأفراد.",
        ]
      },
      accordion3: {
        title: "مميزات شركة صيت لمكافحة بق الفراش:",
        content: [
          "الخبرة والاحترافية: تمتلك الشركة خبرة واسعة في مكافحة بق الفراش وتعمل بشكل احترافي لتقديم خدمات عالية الجودة.",
          "استخدام التقنيات المتقدمة: تستخدم صيت تقنيات وأدوات حديثة لاكتشاف بق الفراش ومكافحته بفعالية. تعتمد على تقنيات حديثة لضمان القضاء الشامل على بق الفراش.",
          "حلول مخصصة: تقدم الشركة حلولاً مخصصة ومبتكرة لمكافحة بق الفراش بناءً على دراسة كل حالة وتوفير استراتيجيات فردية لكل عميل وفقًا لاحتياجاته الخاصة.",
          "الدعم الفني والاستشارات: تقدم صيت الدعم الفني المستمر والاستشارات لعملائها. توفر نصائح وإرشادات للحفاظ على المناطق المعالجة خالية من بق الفراش ومنع عودة الإصابة.",
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صست لمكافحة بق الفراش حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
  ...
  const translatePathname = (path, language) => {
    const translations = {
      ...
      "bed-bugs": language === 'ar' ? "بق الفراش" : "Bed Bugs",
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={bed_bug_control} className="d-block img-fluid w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
              ...
              <div className="carousel-item ">
                <div className="img-services">
                  <img src={bed_bugs1} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
              ...
              <div className="carousel-item">
                <div className="img-services">
                  <img src={bed_bugs2} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
          ...
          <div className="rite-side col-md-8">
            ...
            <div className="Advantages-section row m-0">
              <div className='Advantages col-md-12 col-10 '>
                ...
                <div className='Advantages-right-side col-md-7 col-12'>

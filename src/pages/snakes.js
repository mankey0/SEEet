...
import snake_control from '../assets/Pest and Rodent Control/snake_control.jpg'
import rat1 from '../assets/Pest and Rodent Control/snake.jpg'
import rat2 from '../assets/Pest and Rodent Control/snake2.jpeg'
...
const Snakes = ({ language }) => {
  ...
  const text = {
    en: {
      ...
      caption_services: {
        title: "Snakes Control Services",
        caption: "Snakes are creatures that pose significant risks to both humans and animals. Their presence in or around buildings can be highly concerning, especially if the species is venomous. Some snake species, such as cobras and vipers, contain potent toxins that can lead to death if not treated promptly. These species require immediate professional intervention for safe removal from the area. Snakes may approach buildings in search of food or a safe place to hide.",
        subheading_1: "Dangers of Snakes:",
        subheading_2: "The Correct Way to Get Rid of Snakes:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Snakes pose various direct and indirect threats to humans and animals. The level of danger depends on whether the snake is venomous or non-venomous. Below are the key risks associated with snakes:",
        content: [
          ". Venomous Bites: Venomous snake bites are among the most severe risks, causing: Paralysis of the nervous system.",
          "Disease Transmission: Snakes may carry and transmit certain diseases through their saliva or waste, posing indirect health risks.",
          "Threat to Pets: Snakes pose a significant danger to pets, as they may attack and even kill them, especially venomous species.",]
      },
      ...
      accordion2: {
        ...
        content: [
          "Maintain a Clean and Organized Environment: Regularly clean your yard or garden to remove tall grass and potential hiding spots. Get rid of woodpiles, rocks, and clutter that might serve as snake shelters.",
          "Use Natural or Chemical Snake Repellents: Use essential oils like cinnamon or peppermint oil as natural snake repellents. Commercial chemical repellents can also be effective when used according to the instructions.",
          " Ensure Proper Lighting:Keep the surroundings of your home well-lit, as snakes tend to move in dark areas",
        ]
      },
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "seet Snakes Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
    ...
    ar: {
      banner: {
        title: 'مكافحة الافاعي(الثعابين)',
        home: 'الرئيسية',
        services: 'الخدمات',
      },
      caption_services: {
        title: "خدمات مكافحة الافاعي(الثعابين) ",
        caption: "تعتبر الثعابين من الكائنات التي تشكل مخاطر جسيمة على البشر والحيوانات. وجودها في أو حول المباني يمكن أن يكون أمرًا مقلقًا للغاية، خاصةً إذا كانت الأنواع سامة. بعض أنواع الثعابين، مثل الكوبرا والأفعى المقرنة، تحتوي على سموم قوية قد تؤدي إلى الوفاة إذا لم يتم العلاج بشكل سريع. تتطلب هذه الأنواع تدخلًا مهنيًا فوريًا لإزالتها بأمان من المنطقة. الثعابين قد تقترب من المباني بحثًا عن الطعام أو مكان آمن للاختباء. ",
        subheading_1: " مخاطر الافاعي(الثعابين):",
        subheading_2: " الطريقة الصحيحة للتخلص من الافاعي(الثعابين) :",
        subheading_3: " مميزات شركة صيت:",
      },
      accordion1: {
        title: "الأفاعي تعد من الكائنات الخطرة التي تشكل تهديدًا مباشرًا للإنسان والحيوان. تعتمد درجة الخطر على نوع الأفعى، إذ توجد أنواع سامة وغير سامة. وفيما يلي أهم المخاطر المرتبطة بالأفاعي:",
        content: [
          "للدغات السامة: تعتبر لدغات الأفاعي السامة من أخطر التهديدات الصحية، حيث يؤدي سمها إلى: شلل الجهاز العصبي.",
          "نقل الأمراض: يمكن للأفاعي أن تكون ناقلة لبعض الأمراض من خلال لعابها أو فضلاتها، مما يسبب مخاطر صحية غير مباشرة.",
          "خطر على الحيوانات الأليفة: الأفاعي تشكل تهديدًا كبيرًا للحيوانات الأليفة، حيث يمكن أن تهاجمها وتسبب وفاتها إذا كانت سامة.",
        ]
      },
      accordion2: {
        title: "للتخلص الفعال من الافاعي(الثعابين) يجب اتباع الخطوات التالية:",
        content: [
          " الحفاظ على البيئة نظيفة ومنظمة: قم بتنظيف الفناء أو الحديقة بانتظام للتخلص من الحشائش الطويلة والأماكن التي يمكن أن تختبئ فيها الأفاعي. تخلص من أكوام الحطب، الصخور، والخردة التي قد تشكل مأوى للأفاعي.",
          "ستخدام طاردات الأفاعي الطبيعية أو الكيميائية: استخدم الزيوت العطرية مثل زيت القرفة أو النعناع، حيث يقال إنها تعمل كطارد طبيعي للأفاعي. يمكن أيضًا استخدام المنتجات الكيميائية المخصصة لطرد الأفاعي، مع التأكد من استخدامها بطريقة آمنة وفق التعليمات.",
          "الحفاظ على الإضاءة الجيدة: تأكد من أن المناطق المحيطة بالمنزل مضاءة جيدًا، حيث تميل الأفاعي إلى التحرك في الظلام.",
        ]
      },
      accordion3: {
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صيت لمكافحة الافاعي(الثعابين)  حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={snake_control} className="d-block img-fluid w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>

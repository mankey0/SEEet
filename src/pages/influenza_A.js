...
import influenzaA_Disinfection from '../assets/Pest and Rodent Control/InfluenzaA control.jpg'
import influenzaA_1 from '../assets/Pest and Rodent Control/influenzaA-1.jpg'
import influenzaA_2 from '../assets/Pest and Rodent Control/influenzaA-2.jpg'
...
const InfluenzaA = ({ language }) => {
  ...
  const text = {
    en: {
      banner: {
        title: 'Influenza A Control',
        home: 'Home',
        services: 'Services',
      },
      caption_services: {
        title: "Influenza A Control Services",
        caption: "Influenza A is a type of flu virus that affects the respiratory system. It is the most common type of influenza and is known for its ability to mutate constantly, making it a persistent challenge for scientists and healthcare professionals.",
        subheading_1: "Dangers of Influenza A:",
        subheading_2: "The Correct Way to Get Rid of Influenza A:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Influenza A is a type of flu virus that affects the respiratory system. It is one of the most common types of influenza and is known for its ability to mutate constantly, making it a persistent challenge for scientists and healthcare professionals:",
        content: [
          "Rapid transmission and outbreaks within communities.",
          "Can lead to severe respiratory illnesses like pneumonia.",
          "Higher risk for vulnerable individuals such as the elderly, children, and those with chronic conditions.",
          "Can cause life-threatening complications in some cases.",
        ]
      },
      ...
      accordion2: {
        title: "The Correct Way to Get Rid of Influenza A:",
        content: [
          "Rest: It’s important to get plenty of rest to help the body recover.",
          "Hydrate: Drinking plenty of water and juices helps prevent dehydration and relieves symptoms.",
          "Antiviral Medications: A doctor may prescribe antiviral medications like oseltamivir to reduce the severity and duration of the illness.",
          "Pain Relievers: Use pain relievers like acetaminophen or ibuprofen to ease fever and pain.",
          "Maintain Hygiene: Wash hands frequently, and use tissues when coughing or sneezing to minimize the spread of the virus.",
        ]
      },


      accordion3: {
        title: "Features of Sert  Influenza A Control Company:",
        content: [
          "Experience and Professionalism: The company has extensive experience in  Influenza A control and works professionally to provide high-quality services.",
          "Use of Advanced Technologies: Sert uses advanced technologies and modern tools to detect and effectively control  Influenza A. It relies on modern techniques to ensure comprehensive elimination of cockroaches.",
          "Customized Solutions: The company offers customized and innovative solutions for  Influenza A control, based on studying each case and providing individualized strategies for each client according to their specific needs.",
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "Sert  Influenza A Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
    ...
    ar: {
      banner: {
        title: 'مكافحة إنفلونزا A',
        home: 'الرئيسية',
        services: 'الخدمات',
      },
      caption_services: {
        title: "خدمات مكافحة إنفلونزا A",
        caption: "إنفلونزا A هي نوع من فيروسات الإنفلونزا التي تصيب الجهاز التنفسي. تُعتبر النوع الأكثر شيوعًا من الإنفلونزا، وتتميز بقدرتها المستمرة على التحور، مما يجعلها تحديًا دائمًا للعلماء والمتخصصين في الرعاية الصحية.",
        subheading_1: " مخاطر إنفلونزا A :",
        subheading_2: " الطريقة الصحيحة للتخلص من إنفلونزا A:",
        subheading_3: " مميزات شركة صيت:",
      },
      accordion1: {
        title: "إنفلونزا A هي نوع من أنواع فيروسات الإنفلونزا التي تصيب الجهاز التنفسي. يعتبر هذا الفيروس من أكثر الأنواع شيوعًا، ويتميز بقدرته على التحور المستمر، مما يجعله تحديًا مستمرًا للعلماء والأطباء:",
        content: [
          "العدوى السريعة والتفشي في المجتمعات.",
          "يمكن أن تؤدي إلى أمراض تنفسية خطيرة مثل الالتهاب الرئوي.",
          "خطر الإصابة بالأشخاص ذوي المناعة الضعيفة مثل كبار السن، الأطفال، والأشخاص المصابين بأمراض مزمنة.",
          "يمكن أن تؤدي إلى مضاعفات صحية تهدد الحياة في بعض الحالات.",
        ]
      },
      accordion2: {
        title: "للتخلص الفعال من إنفلونزا A يجب اتباع الخطوات التالية:",
        content: [
          "الراحة التامة: من المهم الحصول على قسط كافٍ من الراحة للسماح للجسم بالتعافي.",
          "شرب السوائل: يساعد شرب كميات كبيرة من الماء والعصائر في تجنب الجفاف وتخفيف الأعراض.",
          "الأدوية المضادة للفيروسات: يمكن أن يصف الطبيب أدوية مضادة للفيروسات مثل الأوسيلتاميفير لتقليل شدة المرض ومدة الإصابة.",
          "استخدام مسكنات الألم: مثل الباراسيتامول أو الإيبوبروفين لتخفيف الحمى والألم.",
          "الحفاظ على النظافة: غسل اليدين بانتظام، واستخدام مناديل عند السعال أو العطس للحد من انتشار الفيروس.",
        ]
      },
      accordion3: {
        title: "مميزات شركة صيت لمكافحة إنفلونزا A:",
        content: [
          "الخبرة والاحترافية: تمتلك الشركة خبرة واسعة في مكافحة إنفلونزا A وتعمل بشكل احترافي لتقديم خدمات عالية الجودة.",
          "استخدام التقنيات المتقدمة: تستخدم صيت تقنيات وأدوات حديثة لاكتشاف إنفلونزا A ومكافحته بفعالية. تعتمد على تقنيات حديثة لضمان القضاء الشامل على إنفلونزا A.",
          "حلول مخصصة: تقدم الشركة حلولاً مخصصة ومبتكرة لمكافحة إنفلونزا A بناءً على دراسة كل حالة وتوفير استراتيجيات فردية لكل عميل وفقًا لاحتياجاته الخاصة.",
          "الدعم الفني والاستشارات: تقدم صيت الدعم الفني المستمر والاستشارات لعملائها. توفر نصائح وإرشادات للحفاظ على المناطق المعالجة خالية من إنفلونزا A ومنع عودة الإصابة.",
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صست لمكافحة إنفلونزا A حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={influenzaA_Disinfection} className="d-block img-fluid w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
              ...
              <div className="carousel-item ">
                <div className="img-services">
                  <img src={influenzaA_1} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
              ...
              <div className="carousel-item">
                <div className="img-services">
                  <img src={influenzaA_2} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">

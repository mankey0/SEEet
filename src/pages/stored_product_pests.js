...
import StoredProductPests_control from '../assets/Pest and Rodent Control/stored-product-pests control.jpg'
import StoredProductPests1 from '../assets/Pest and Rodent Control/stored-product-pests-1.jpg'
import StoredProductPests2 from '../assets/Pest and Rodent Control/StoredProductPests-2.jpg'
...
const StoredProductPests = ({ language }) => {
  ...
  const text = {
    en: {
      banner: {
        title: 'Stored Product Pests Control',
        home: 'Home',
        services: 'Services',
      },
      caption_services: {
        title: "Stored Product Pests Control Services",
        caption: "Stored Product Insects are a large group of pests, including beetles and moths. They are responsible for contaminating and destroying food and goods each year. The presence of these pests, whether dead or alive, poses significant health risks to humans. These insects often infest stored products, leading to economic losses and potential contamination with harmful bacteria or allergens. Proper pest management and hygiene practices are crucial to prevent these pests from damaging stored goods and affecting public health.",
        subheading_1: "Dangers of Stored Product Pests:",
        subheading_2: "The Correct Way to Get Rid of Stored Product Pests:",
        subheading_3: "Features of seet:",
      },

      accordion1: {
        title: "Stored product pests, such as weevils, beetles, and moths, can infest stored food products like grains, legumes, nuts, spices, and more. These pests pose several risks:",
        content: [
          " Product Damage: Pests feed on and destroy stored food products, leading to significant financial losses. The infested goods may become unsuitable for consumption or sale.",
          "Disease Transmission: These pests may carry pathogens that can infect humans when contaminated food is consumed.",
          "Environmental Impact: Excessive use of pesticides to control these pests can have harmful effects on the environment if not used responsibly.",
        ]
      },
      ...
      accordion2: {
        title: "The Correct Way to Get Rid of Stored Product Pests:",
        content: [
          "Regular Inspection: Frequently inspect stored products for signs of infestation, such as droppings, holes, or the presence of insects.",
          "Proper Storage: Use airtight containers to store food items, keeping pests out. Store food in cool, dry places away from moisture, as humidity encourages pest growth.",
          "Seek Expert Assistance: For persistent or severe infestations, consult pest control professionals to ensure effective eradication.",
        ]
      },
      ...
      accordion4: {
        title: "In summary,",
        content: [
          "seet Stored Product Pests Control Company offers effective and customized solutions, with a focus on experience, professionalism, and quality. It relies on modern technologies and provides technical support to clients, while committing to quality and safety in all its services."
        ]
      },
    ...
    ar: {
      banner: {
        title: 'مكافحة آفات المنتجات المخزنة',
        home: 'الرئيسية',
        services: 'الخدمات',
      },
      caption_services: {
        title: "خدمات مكافحة آفات المنتجات المخزنة",
        caption: "الحشرات التي تصيب المنتجات المخزنة تشكل مجموعة كبيرة من الآفات، تشمل الخنافس والعث. تتحمل هذه الحشرات مسؤولية تلوث وتدمير الأغذية والبضائع سنويًا. يشكل وجود هذه الآفات، سواء كانت حية أو ميتة، مخاطر صحية كبيرة على الإنسان. غالبًا ما تغزو هذه الحشرات المنتجات المخزنة، مما يؤدي إلى خسائر اقتصادية واحتمال التلوث بالبكتيريا الضارة أو المواد المسببة للحساسية. تعتبر إدارة الآفات السليمة وممارسات النظافة أمورًا ضرورية لمنع هذه الحشرات من الإضرار بالمنتجات المخزنة والتأثير على الصحة العامة.",
        subheading_1: " مخاطر آفات المنتجات المخزنة:",
        subheading_2: " الطريقة الصحيحة للتخلص منآفات المنتجات المخزنة :",
        subheading_3: " مميزات شركة صيت:",
      },
      accordion1: {
        title: "آفات المنتجات المخزنة تشمل الحشرات مثل السوس، الخنافس، والعث التي تصيب الأغذية المخزنة مثل الحبوب، البقوليات، المكسرات، البهارات وغيرها. وجود هذه الآفات يمكن أن يؤدي إلى أضرار كبيرة. وفيما يلي أبرز المخاطر:",
        content: [
          "لف المنتجات المخزنة: تسبب الآفات تآكل الأغذية وتدميرها من خلال التغذية عليها، مما يؤدي إلى خسائر مالية كبيرة. قد تكون المنتجات المخزنة غير صالحة للاستخدام أو البيع.",
          "نقل الأمراض: يمكن أن تحمل هذه الآفات ميكروبات ممرضة تنتقل إلى الإنسان عند استهلاك الأغذية المصابة.",
          "تأثير بيئي: انتشار الآفات قد يدفع إلى استخدام مفرط للمبيدات، مما قد يسبب أضرارًا بيئية عند استخدام المواد الكيميائية بطريقة غير مدروسة.",
        ]
      },
      accordion2: {
        title: "للتخلص الفعال من آفات المنتجات المخزنة يجب اتباع الخطوات التالية:",
        content: [
          "الفحص المنتظم: افحص المنتجات المخزنة بشكل دوري للتأكد من خلوها من الحشرات أو أي علامات على وجود الآفات مثل الفضلات أو الثقوب.",
          "التخزين الجيد: استخدم حاويات محكمة الإغلاق لتخزين المنتجات الغذائية لحمايتها من وصول الآفات. خزّن الأطعمة في أماكن جافة وباردة وبعيدة عن الرطوبة، حيث أن الرطوبة تشجع على نمو الآفات.",
          "الاستعانة بالخبراء: في حالة وجود إصابة مستمرة أو كبيرة، تواصل مع شركات متخصصة في مكافحة آفات المنتجات المخزنة لضمان القضاء عليها بفعالية.",]
      },
      accordion3: {
        title: "مميزات شركة صيت لمكافحة الافاعي(الثعابين):",
        content: [
          "الخبرة والاحترافية: تمتلك الشركة خبرة واسعة في مكافحة الافاعي(الثعابين)  وتعمل بشكل احترافي لتقديم خدمات عالية الجودة.",
          "استخدام التقنيات المتقدمة: تستخدم صيت تقنيات وأدوات حديثة لاكتشاف الافاعي(الثعابين)  ومكافحته بفعالية. تعتمد على تقنيات حديثة لضمان القضاء الشامل على الافاعي(الثعابين) .",
          "حلول مخصصة: تقدم الشركة حلولاً مخصصة ومبتكرة لمكافحة الافاعي(الثعابين)  بناءً على دراسة كل حالة وتوفير استراتيجيات فردية لكل عميل وفقًا لاحتياجاته الخاصة.",
          "الدعم الفني والاستشارات: تقدم صيت الدعم الفني المستمر والاستشارات لعملائها. توفر نصائح وإرشادات للحفاظ على المناطق المعالجة خالية من الافاعي(الثعابين)  ومنع عودة الإصابة.",
      ...
      accordion4: {
        title: "باختصار:",
        content: [
          "تقدم شركة صيت لمكافحة آفات المنتجات المخزنة  حلولًا فعالة ومخصصة، مع التركيز على الخبرة والاحترافية والجودة. تعتمد على التقنيات الحديثة وتوفر الدعم الفني للعملاء، مع الالتزام بالجودة والسلامة في جميع خدماتها."
        ]
      },
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="img-services">
                  <img src={StoredProductPests_control} className="d-block img-fluid w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
              ...
              <div className="carousel-item ">
                <div className="img-services">
                  <img src={StoredProductPests1} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
              ...
              <div className="carousel-item">
                <div className="img-services">
                  <img src={StoredProductPests2} className="d-block w-100" alt="صيت السعودية لخدمات مكافحة الآفات والقوارض، مكافحة الآفات هي خبرتنا صيت السعوديه للخدمات البيئية مكافحه الحشــــــرات لعبتنــــــــــــا" />
                </div>
                <div className="carousel-caption d-md-block">
                  <h1>{text[language].banner.title}</h1>
                  <div className="breadcrumb">
...
export default StoredProductPests;
